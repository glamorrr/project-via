    ...
    <VCol cols="12" lg="5" class="d-flex align-center justify-center auth-bg">
        <VCard flat :max-width="500" class="mt-12 mt-sm-0 pa-4 w-100" color="black" theme="dark" rounded="xl">
          <VCardText class="mb-4 text-center">
            <h5 class="text-h5 font-weight-semibold mb-1">Find your account!</h5>
            <p class="mb-0">Enter the email or phone number associated with your account to change your password</p>
          </VCardText>
          <VCardText>
            <VForm ref="refVForm"
                ...
                <VCol cols="12">
                  ...
                  <VBtn 
                      ...
                      <div class="d-flex justify-center mt-2 mb-4">
                        <p class="text-center mb-2 pa-0" style="font-size:.867rem">Back to <router-link to="/login">Log In</router-link></p>
                    </div>
                </VCol>
              </VRow>
            </VForm>
