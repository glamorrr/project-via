...
import avatar7 from "@images/avatars/ava-si-7.png";
...
const database = [
  {
    ...
    username: "via@mhs.uinjkt.ac.id",
    password: "123456",
    avatar: avatar7,
    email: "via@mhs.uinjkt.ac.id",
    status: "mahasiswa",
    role: "admin",
    abilities: [
      {
...
mock.onPost("/auth/register").reply((request) => {
  ...
  if (!errors.username && !errors.email) {
    ...
    let lastIndex = 0;
    if (length) lastIndex = database[length - 1].id;
    lastIndex += 1;
