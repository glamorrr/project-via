...
import himsiPng from "@images/logos/himsi.png";
import himatikaPng from "@images/logos/himatika.png";
import himtiPng from "@images/logos/himti.png";
import himbioPng from "@images/logos/himbio.png";
import hitamPng from "@images/logos/hitam.png";
import himafiPng from "@images/logos/himafi.png";
import hmjPng from "@images/logos/hmj.png";
import himkaPng from "@images/logos/himka.png";
...
const database = [
  {
    ...
    Harga Mahasiswa UIN Jakarta 99k dengan benefit berupa Exclusive Seat for offline, Exhibition Career - Creative Industry, E-Certificate Nasional (Kuliah Umum 6 SKPI), Relation dan Doorprize menarik lainnya.
        <lu>
          <li>Fundamental Digital Martketing</li>
          <li>Social Media Martketing</li>
          <li>Copwriting for Social Media</li>
          <li>Permormace Marketing</li>
  ...
  },
  {
    ...
    <p>
    1. Prof. Dr. Arif Satria, SP, M.SI [Rektor IPB University dan Ketua Ikatan Cendekiawan Muslim Indonesia]
    </p>
    <p>
    2. Dr. Ir. Siti Munifah, M.Si[ Sekretaris Badan PPSDMP Kementerian Pertanian]
    </p>
    <p>
  ...
  },
  {
    ...
    text: `<p>Persyaratan</p>
              <ul>
                      ...
                      <li>
                        Mampu membuat Konten yang Out of  The Box
                      </li>
                      <li>
                        Mampu membuat Script untuk Video
                      </li>
                      <li>
                        Memiliki Skill Copywriting
                      </li>
                      <li>Jurusan ilmu Komunikasi, DKV, dan Bidang ilmu Terkait lebih utamakan</li>
              </ul>
              <p>
    ...
    text2: `<p>Link Pendaftaran: <a href="#">https://www.instagram.com/p/Cs5K-hYhWQd/</a></p>
              ...
              <br><br>
              <p>
              Kalau ada pertanyaan, kamu bisa hubungi CP:
              </p>
              <p>
              Email : Baroteradigital@gmail.com
              </p>
              <br><br>
  ...
  },
  {
    ...
    <ul>
              <p>
                ✅ Mahasiswa/i aktif UIN Syarif Hidayatullah Jakarta
              </p>
              <p>
                 ✅ Minimal IPK 3.00 (diutamakan untuk semester 4 & 6)
              </p>
              <p>
              ✅ Mengisi formulir registrasi <a href="#">(https://bit.ly/Registrasi-InternS5)</a>
              </p>
              <p>
                ✅ Bersedia dan berkomitmen selama periode magang
              </p>
              <p>
                ✅ Kesibukan maksimal di 1 Organisasi
              </p>
              <p>
                 ✅ Tidak terlibat dalam internship lain
              </p>
              <p>
                ✅ Melampirkan Surat Rekomendasi, CV, transkrip nilai, dan Portofolio apabila ada (Wajib bagi pelamar Sosial Media Creative Team)
              </p>
    ...
    text2: `<b>Formulir Registrasi:</b>
               ...
               <b>Job Description::</b>
               <p>
                 <a href="#">📎 https://bit.ly/booklet-internS5</a>
               </p>
               <b>
               Deadline Registrasi: 
               </b>
               <p> 
                   📆 9 Maret 2023 - Pukul 20.00 WIB
               </p>
               <br><br>
               <b>Kalau kamu mengalami kendala selama proses registrasi, silahkan hubungi:</b>
      <ul>
        <p>📞 Khansa (<a href="#">wa.me/+6285718812958</a>)</p>
  ...
  },
  {
    ...
    text: `<p>💎💎 PRIZEPOOL UP TO 6000 💎💎</p>   
              ...
              <ul>
                ...
                <li>
                  Must Pick Thamuz Until Semifinal.
                </li>
                <li>
    ...
    text2: `<p>Khusus Mahasiswa UIN Jakarta</b>
              <lu>
                ...
                <p>📝Open Regist : Now - 06 June 2023</p>
                <p>🖊️Form Regist : <a href="#">http:// bit.ly/UINJKTSLTHAMUZ</a></p>
                <p>🗓️ Matchday : 07 June 2023</p>
                <p>⏱️ Date : 18.30 WIB - Finish</p>            
                <p>📍Venue : Online</p>
                <p>🎥 Live on Facebook Esport Uin Jkt</p>
              </lu>
    
                <br><br>
                <p>Nb: Hadiah dapat berubah sewaktu-waktu sesuai slot yang terisi</p
          <p>#infotournament</p>
  ...
  },
  {
    ...
    text: `<p>Yuk daftar dan ikuti Kuliah Umum & Talkshow Creative Industry bertema “One Step To Recognize Your Potential, Towards Disruptive Innovation In Achieving A Bright Future”
      ...
      <p>
      Ikuti dan menangkan Grand Prize
      </p>
      <p>
      Rp 2.000.000
      </p>
  ...
  },
  {
    ...
    text: `<p>✨ Hadiah ✨</p>
              ...
              <p>
                Juara Kedua: Rp. 1.250.000
              </p>
              <p>
                Juara Ketiga: Rp. 1.000.000
              </p>
              <p>
                Honorable Mention: Rp. 500.000
              </p>
              <p>📃Ruang Lingkup📃</p>
              <ul>
                <li>
    ...
    text2: `<b>Registrasi (Judul): 10 Maret 2023</b>
                ...
                <p>📎 Link Panduan Penulisan JIKA <br><a href="#">http://bit.ly/JIKA_pedoman_penulisan</a></p>
                <p>
                  📎 Link Template JIKA <br><a href="#">http://bit.ly/JIKA_template</a>
                </p>
                <p>
                  📎 Submit naskah ke <br><a href="#">http://bit.ly/WritingCompetitionJIKA</a>
                </p>
                <p>
                📧 E-mail : jika@apps.ipb.ac.id
                </p>
                <p>
                📱CP: 0898-1064-804 (Aini)
                </p>
                <br><br>
                <p>With love,Pusat Karier UIN Jakarta</p>
  ...
  },
  {
    ...
    text: `<p>Yuk ikutan Pre Job Training IKALBIO UIN Jakarta!!</p>
      ...
      <p>
      Kamu akan dibekali kiat-kiat sukses dunia kerja oleh pembicara yang sudah ahli dengan jejak pengalamannya.
      </p>
      <p>
      Jangan sampai ketinggalan karna KUOTA TERBATAS 20 orang aja! dan Peserta *WAJIB* mengikuti training selama 2 hari...
      </p>
      <p>
  ...
  },
  {
    ...
    text: `<p>Mekanika (Mengenal Keluarga Fisika) adalah kegiatan untuk para Mahasiswa aktif serta Alumni Fisika untuk lebih mengenal satu sama lain dan mempererat silaturahmi. Nah, seru banget nih jadi bisa dapat banyak ilmu tentang dunia pekerjaan dari para Kakak-kakak Alumni kita.</p>
      ...
      <p>
      Jangan lupa membawa tumblr pribadi ya 🤩
      </p>
      <p>
      Pembayarannya bisa secara langsung atau online melalui dana:
      </p>
      <p>
      💳 BCA 2180337451 a/n Zahwa Lailatul Fadilah
      </p>
      <p>
